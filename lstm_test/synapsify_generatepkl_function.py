...
"""
This code is used for generating a single ".pkl" file storing both training and testing dataset, and the parameters are passed from another python file.
"""
...
### Non shuffled get_sentiment_indices():
